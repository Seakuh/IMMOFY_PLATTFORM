import { Clock, Heart, Search, type LucideIcon } from "lucide-react";
...
const emptyStates: Record<
  ...
  { icon: LucideIcon; title: string; description: string; actionText?: string }
> = {
  search: {
    icon: Search,
  ...
  favorites: {
    ...
    description:
      "Markiere interessante Profile als Favoriten, um sie hier zu finden.",
  },
  history: {
    icon: Clock,
