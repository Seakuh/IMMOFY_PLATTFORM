        ...
        <div className="p-6 flex-1 overflow-y-auto">
          {currentStep === "welcome" && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Lass uns gemeinsam dein perfektes Inserat erstellen. Wir führen
          ...
          {currentStep === "images" && (
            <div className="py-4">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">
                  Bilder sind optional, aber sie machen dein Inserat viel
                  attraktiver.
                </p>
              </div>
          ...
          {currentStep === "email" && (
            <div className="py-4">
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs text-gray-500">
                  Wir verwenden deine E-Mail nur für Kontaktanfragen zu deinem
                  Inserat.
                </p>
              </div>
            </div>
          ...
          {currentStep === "complete" && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Wir haben alle Informationen erhalten. Dein Inserat wird jetzt
                erstellt und online gestellt.
              </p>
