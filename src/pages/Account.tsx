...
export default function Account() {
  ...
  const { threads, logs } = useContactsStore()
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="text-center p-4 bg-purple-50 rounded-lg">
                    <div className="text-2xl font-bold text-purple-600">{threads.length}</div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-500">Deine Immobilienanzeigen bearbeiten</p>
                  </button>
                  <button 
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-500">Gespeicherte Profile ansehen</p>
                  </button>
                </div>
              </div>
            </div>
